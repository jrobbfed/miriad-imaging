...
if ($remove_baselines == "6m10m") then 
	...
	uvcat vis=$carvis out="cartmp2.mir" select="-ant(1,2,3,4,5,6)(3)"
	set carvis = "cartmp2.mir"
endif
set remove_baselines = "6m6m"
if ($remove_baselines == "6m6m") then 
	uvcat vis=$carvis out="cartmp3.mir" select="-ant(7,8,9,10,11,12,13,14,15)(3)"
...
mv 13co/13co.001/ 13co/13co.001_all-3
fits in=13co/combined_all-3_13co.map out=13co/baseline_test/all-3.map.fits op=xyout
fits in=13co/13co.001_all-3/13co.001.cm out=13co/baseline_test/all-3.cm.fits op=xyout
