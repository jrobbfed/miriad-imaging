...
set dirty_name = 'combined_6m10m-10m10m-6m6m-11.12.13.14.15'
set source = 'omc42'
set robust = 2
set cell = 1
set imsize = 257 
...
if ($remove_baselines == "6m6m") then 
	uvcat vis=$carvis out="cartmp3.mir" select="-ant(11,12,13,14,15)(11,12,13,14,15)"
...
mv 13co/13co.001/ 13co/13co.001_6m10m-10m10m-6m6m-11.12.13.14.15
fits in=13co/combined_6m10m-10m10m-6m6m-11.12.13.14.15_13co.map out=13co/baseline_test/6m10m-10m10m-6m6m-11.12.13.14.15.map.fits op=xyout
fits in=13co/13co.001_6m10m-10m10m-6m6m-11.12.13.14.15/13co.001.cm out=13co/baseline_test/6m10m-10m10m-6m6m-11.12.13.14.15.cm.fits op=xyout
