...
set dirty_name = 'combined_all-15'
set source = 'omc42'
set robust = 2
set cell = 1
set imsize = 257 
...
if ($remove_baselines == "6m6m") then 
	uvcat vis=$carvis out="cartmp3.mir" select="-ant(7,8,9,10,11,12,13,14,15)(15)"
...
mv 13co/13co.001/ 13co/13co.001_all-15
fits in=13co/combined_all-15_13co.map out=13co/baseline_test/all-15.map.fits op=xyout
fits in=13co/13co.001_all-15/13co.001.cm out=13co/baseline_test/all-15.cm.fits op=xyout
