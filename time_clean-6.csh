...
if ($remove_baselines == "6m10m") then 
	...
	uvcat vis=$carvis out="cartmp2.mir" select="-ant(1,2,3,4,5,6)(6)"
	set carvis = "cartmp2.mir"
endif
set remove_baselines = "6m6m"
if ($remove_baselines == "6m6m") then 
	uvcat vis=$carvis out="cartmp3.mir" select="-ant(7,8,9,10,11,12,13,14,15)(6)"
...
mv 13co/13co.001/ 13co/13co.001_all-6
fits in=13co/combined_all-6_13co.map out=13co/baseline_test/all-6.map.fits op=xyout
fits in=13co/13co.001_all-6/13co.001.cm out=13co/baseline_test/all-6.cm.fits op=xyout
