...
set dirty_name = 'combined_all-13'
set source = 'omc42'
set robust = 2
set cell = 1
set imsize = 257 
...
if ($remove_baselines == "6m10m") then 
	...
	uvcat vis=$carvis out="cartmp2.mir" select="-ant(1,2,3,4,5,6)(13)"
	set carvis = "cartmp2.mir"
endif
set remove_baselines = "6m6m"
if ($remove_baselines == "6m6m") then 
	uvcat vis=$carvis out="cartmp3.mir" select="-ant(7,8,9,10,11,12,13,14,15)(13)"
...
mv 13co/13co.001/ 13co/13co.001_all-13
fits in=13co/combined_all-13_13co.map out=13co/baseline_test/all-13.map.fits op=xyout
fits in=13co/13co.001_all-13/13co.001.cm out=13co/baseline_test/all-13.cm.fits op=xyout
