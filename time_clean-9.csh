...
if ($remove_baselines == "6m10m") then 
	...
	uvcat vis=$carvis out="cartmp2.mir" select="-ant(1,2,3,4,5,6)(9)"
	set carvis = "cartmp2.mir"
endif
set remove_baselines = "6m6m"
if ($remove_baselines == "6m6m") then 
	uvcat vis=$carvis out="cartmp3.mir" select="-ant(7,8,9,10,11,12,13,14,15)(9)"
...
mv 13co/13co.001/ 13co/13co.001_all-9
fits in=13co/combined_all-9_13co.map out=13co/baseline_test/all-9.map.fits op=xyout
fits in=13co/13co.001_all-9/13co.001.cm out=13co/baseline_test/all-9.cm.fits op=xyout
