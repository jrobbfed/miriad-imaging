...
if ($remove_baselines == "6m10m") then 
	...
	uvcat vis=$carvis out="cartmp2.mir" select="-ant(1,2,3,4,5,6)(1)"
	set carvis = "cartmp2.mir"
endif
set remove_baselines = "6m6m"
if ($remove_baselines == "6m6m") then 
	uvcat vis=$carvis out="cartmp3.mir" select="-ant(7,8,9,10,11,12,13,14,15)(1)"
...
mv 13co/13co.001/ 13co/13co.001_all-1
fits in=13co/combined_all-1_13co.map out=13co/baseline_test/all-1.map.fits op=xyout
fits in=13co/13co.001_all-1/13co.001.cm out=13co/baseline_test/all-1.cm.fits op=xyout
